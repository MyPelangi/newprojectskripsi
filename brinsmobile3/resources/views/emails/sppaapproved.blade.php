...
<html>
<head>
    <title>BRINS MOBILE | Permintaan Diterima</title>
...
<body>
    <div class="email-container">
        <div class="email-content">
            ...
            <p>Surat Permintaan Penutupan Asuransi Anda dengan Ref No. {{ $penutupan->ref_penutupan }} melalui Aplikasi BRINSmobile telah kami terima.</p>
